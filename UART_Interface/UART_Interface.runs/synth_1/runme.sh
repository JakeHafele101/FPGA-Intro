...
HD_PWD='C:/Projects/FPGA-Intro/UART_Interface/UART_Interface.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log uart_stopwatch_synth.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source uart_stopwatch_synth.tcl
