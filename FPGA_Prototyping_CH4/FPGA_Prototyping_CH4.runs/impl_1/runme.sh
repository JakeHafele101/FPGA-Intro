...
HD_PWD='C:/Projects/FPGA-Intro/FPGA_Prototyping_CH4/FPGA_Prototyping_CH4.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log stack_synth.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source stack_synth.tcl -notrace
