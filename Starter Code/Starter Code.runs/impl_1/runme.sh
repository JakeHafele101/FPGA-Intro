...
HD_PWD='C:/Users/Jake/OneDrive/Documents/Projects/FPGA-Intro/Starter Code/Starter Code.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log mux4x1.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source mux4x1.tcl -notrace
