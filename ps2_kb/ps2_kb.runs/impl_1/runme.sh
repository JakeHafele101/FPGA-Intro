...
HD_PWD='C:/Projects/FPGA-Intro/ps2_kb/ps2_kb.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log enhanced_stopwatch_ps2_synth.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source enhanced_stopwatch_ps2_synth.tcl -notrace
