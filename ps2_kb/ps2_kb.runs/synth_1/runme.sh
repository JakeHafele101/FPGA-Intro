...
HD_PWD='C:/Projects/FPGA-Intro/ps2_kb/ps2_kb.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log enhanced_stopwatch_ps2_synth.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source enhanced_stopwatch_ps2_synth.tcl
